        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/hsicen/kotlinmaven/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/hsicen/kotlinmaven.git")
                        developerConnection.set("scm:git:ssh://github.com/hsicen/kotlinmaven.git")
                        url.set("https://github.com/hsicen/kotlinmaven/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/hsicen/kotlinmaven/issues")
                    }
                }
            }
        }
